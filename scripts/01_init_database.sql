...
The script creates a new database called 'DataWarehouseAnalytics'after checking if it already exists. If the Database exists, it is dropped and recreated.
